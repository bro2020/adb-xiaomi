...
Перед вами откроется окно в котором будет пункт $EN"$YE"IP-адрес & Порт$EN
...
"$BL"Пример IP-адрес & Порт:$EN "$GR"192.168.1.2:40105$EN
"$BL"Пример Код подключения Wi-Fi:$EN "$GR"850651$EN
